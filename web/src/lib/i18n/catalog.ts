...
/**
 * Loaded catalogs. Only `en` ships in the binary today; translations arrive via the signed KV
 * manifest (ADR-0014) or future static catalogs. Partial: a locale may omit keys (→ source fallback).
 */
