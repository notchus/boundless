...
// types the Cloudflare bindings exposed by `@sveltejs/adapter-cloudflare` (T15-shell leg A) — the
// WebAuthn challenge KV and (spec 009 T06) the durable admin-session KV. `import type` keeps the KV type
	...
	namespace App {
		...
		interface Platform {
			...
			env?: {
				...
				/** Durable admin-session KV (spec 009 D5/T06). */
